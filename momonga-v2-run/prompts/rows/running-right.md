Create one horizontal animation strip for Codex pet `momonga`, state `running-right`.
...
Identity: same pet in every frame: Preserve the existing soft white flying-squirrel identity, enormous pale-blue striped tail, pink cheeks, tiny bean limbs, and smug mischievous expression language.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
