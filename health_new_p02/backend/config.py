...
class Settings(BaseSettings):
    ...
    go2_audio_enabled: bool = False
    go2_audio_robot_ip: str = ""
    go2_audio_aes_128_key: str = ""
    go2_audio_play_timeout_seconds: float = Field(default=20.0, gt=0, le=120)
    go2_audio_record_max_duration_seconds: float = Field(default=8.0, gt=0, le=60)
    go2_audio_silence_timeout_seconds: float = Field(default=1.2, gt=0, le=10)
    go2_audio_post_playback_silence_ms: int = Field(default=500, ge=0, le=5000)
    go2_audio_asr_timeout_seconds: float = Field(default=20.0, gt=0, le=120)
    go2_audio_tts_timeout_seconds: float = Field(default=20.0, gt=0, le=120)
    go2_audio_silence_rms_threshold: int = Field(default=200, ge=0, le=32767)
