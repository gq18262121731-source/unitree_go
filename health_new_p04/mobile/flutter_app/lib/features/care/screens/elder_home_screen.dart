...
import '../../companion/repositories/companion_repository.dart';
import '../../companion/screens/companion_control_screen.dart';
          ...
          children: [
            ...
            if (authUser != null) ...[
              _buildBigButton(
                ...
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (_) => CompanionControlScreen(
                      repository: CompanionRepository(
                        context.read<ApiClient>(),
                      ),
                      elders: <CompanionElderOption>[
                        CompanionElderOption(
                          id: authUser.id,
                          name: elderName,
                        ),
                      ],
