...
class Settings(BaseSettings):
    ...
    vision_service_base_url: str = "http://127.0.0.1:8011"
    vision_service_local_base_url: str = "http://127.0.0.1:8011"
    ...
    vision_bridge_production_mode: bool = False
    companion_risk_executor_mode: Literal["disabled", "mock"] = "disabled"
    robot_gateway_enabled: bool = True
    robot_gateway_base_url: str = "http://127.0.0.1:8090"
    companion_gateway_base_url: str = "http://127.0.0.1:8093"
    robot_gateway_timeout_seconds: float = 1.5
    companion_bound_elder_id: str = ""
    companion_robot_id: str = "go2_edu_01"
    companion_robot_name: str = "小康01"
    companion_robot_model: str = "Go2 EDU"
