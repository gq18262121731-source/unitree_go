...
from backend.api.elder_companion_api import router as elder_companion_router
...
from backend.api.robot_companion_risk_api import router as robot_companion_risk_router
...
app.include_router(elder_companion_router, prefix=settings.api_v1_prefix)
...
app.include_router(robot_companion_risk_router, prefix=settings.api_v1_prefix)
