...
_file_asr_service = QwenFileAsrService(_settings)
...
async def voice_status() -> dict:
    ...
    return {
        ...
        "asr_model": _file_asr_service.model if configured else None,
